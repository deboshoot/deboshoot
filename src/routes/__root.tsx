...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "DEBOSHOOT — Fotografo professionista. Shooting cinematografici, collaborazioni e ritratti d'autore." },
      { property: "og:title", content: "DEBOSHOOT — Fotografo Professionista" },
